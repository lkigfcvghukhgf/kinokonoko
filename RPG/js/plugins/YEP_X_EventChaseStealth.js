 ...
 */
 /*:ja
 * @plugindesc v1.03 (要YEP_EventChasePlayer.js) Event Chase Playerプラグインにステルス機能を追加します。
 * @author Yanfly Engine Plugins
 *
 * @param ---一般---
 * @default
 ...
 * @param Stealth Regions
 * @parent ---ステルスリージョン---
 * @desc ステルスリージョンIDを設定。 IDはスペースで区切ります。
 * @default 0
 *
 * @param ---ステルスゲージ---
 * @default
 ...
 * @param Gauge Height
 * @parent ---ステルスゲージ---
 * @desc ステルスゲージの幅。ステルスゲージの高さ。式を使えます
 * @default 36
 *
 * @param Gauge Color 1
 * @parent ---ステルスゲージ---
 ...
 * ============================================================================
 *
 * ステルスリージョンは、リージョンIDを使用してマークできるマップ上の場所です。
 * どのリージョンをプラグインパラメータ内でステルスリージョンと見なすか、
 * またはマップのメモ欄内に以下のメモタグを使用して決定できます。
 *
 * <Stealth Regions: x>
 * <Stealth Regions: x, x, x>
 * <Stealth Regions: x to y>
 ...
 * 警告されたイベントはプレイヤーを追いかけます（または逃げます）。
 ...
 * ステルスモードでは、有効になっていると、ステルスゲージは自動的に消えるまでに
 * どれだけ長くステルスモードを維持するかをプレイヤーに警告するように見えます。
 *
 * ============================================================================
 * Plugin Commands
 * ============================================================================
 ...
 *
 *   ShowStealthGauge
 *   - プレイヤーがステルスモードになっている時、ステルスゲージを表示します。
 *
 *   EnableDifferentStealthSpeed
 ...
 * ============================================================================
 *
 * 条件付き分岐にスクリプトコールを使用したり、
 * スクリプト呼び出しでステルスモードを調整したい場合、
 * 次の新しい機能を使用できます。
 *
 * $gamePlayer.isStealthMode()
 * - プレイヤーのステルスモード状態をチェックします。
 ...
 *
 * $gamePlayer.setStealthTimer(x)
 * - これはプレイヤーがステルスモードになるフレームの量を設定します。
 * x を設定したいフレーム数に置き換えます。
 *
 * $gameMap.isStealthRegion(x)
 * - リージョン x がステルスリージョンかどうかをチェックします。
 * もしそうなら、true を返します。
 * そうでなければ、false を返します。
 *
 * ============================================================================
